...
//! HOSTNAME: `bbaf49149354`, CPU: `11th Gen Intel(R) Core(TM) i7-11850H @ 2.50GHz`
...
// --output
// /data/benchmark/runtime/src/weights/cumulus_pallet_parachain_system.rs
// --template
...
/// Weights for `cumulus_pallet_parachain_system` using the zkVerify node and recommended hardware.
pub struct ZKVEvmWeight<T>(PhantomData<T>);

impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for ZKVEvmWeight<T> {
    ...
    fn enqueue_inbound_downward_messages(n: u32, ) -> Weight {
        ...
        Weight::from_parts(434_205_652, 3517)
            // Standard Error: 215_207
            .saturating_add(Weight::from_parts(149_347_768, 0).saturating_mul(n.into()))
