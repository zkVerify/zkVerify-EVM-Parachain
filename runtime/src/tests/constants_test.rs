...
mod constant_tests {
    use zkv_para_evm_runtime::constants::currency::*;
    ...
    fn check_version() {
        assert_eq!(
            ...
            RuntimeVersion {
                ...
                spec_version: 1,
                impl_version: 0,
                apis: zkv_para_evm_runtime::RUNTIME_API_VERSIONS,
...
mod xcm_tests {
    ...
    use zkv_para_evm_runtime::configs::xcm_config::*;
    ...
    fn pallet_xcm_constants() {
        ...
        assert_eq!(
            <zkv_para_evm_runtime::Runtime as pallet_xcm::Config>::VERSION_DISCOVERY_QUEUE_SIZE,
            100
        );
    }
}
