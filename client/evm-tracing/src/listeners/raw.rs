        ...
        match event {
            ...
            GasometerEvent::RecordCost { cost, snapshot } => {
                if let Some(context) = self.context_stack.last_mut() {
                    ...
                    // snapshot.used_gas and snapshot.memory_gas are cumulative, they contain all the gas up until this step.
                    self.final_gas =
                        self.transaction_cost + snapshot.used_gas + snapshot.memory_gas;
                }
            }
